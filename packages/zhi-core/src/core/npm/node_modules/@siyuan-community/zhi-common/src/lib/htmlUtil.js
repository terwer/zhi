 ...
 * questions.
 */
System.register(["./markdownUtil.js"], function (exports_1, context_1) {
    "use strict";
    var markdownUtil_js_1, HtmlUtil;
    var __moduleName = context_1 && context_1.id;
    return {
        setters: [
            function (markdownUtil_js_1_1) {
                markdownUtil_js_1 = markdownUtil_js_1_1;
            }
        ],
        execute: function () {
            /**
             * HTML 处理工具类
             */
            HtmlUtil = class HtmlUtil {
                mdUtil;
                constructor() {
                    this.mdUtil = new markdownUtil_js_1.default();
                }
                /**
                 * 移除标题数字
                 *
