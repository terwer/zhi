    ...
    return {
        ...
        execute: function () {
            ...
            BrowserUtil = class BrowserUtil {
                 ...
                 * @param value - value
                 */
                static setUrlParameter = (urlstring, key, value) => {
                    // 已经有参数了，不重复添加
                 ...
                 * @param t - 延迟时间
                 */
                static reloadTabPage = (tabname, t = 200) => {
                    setTimeout(function () {
                        if (BrowserUtil.isInBrowser) {
                 ...
                 * @param cb - 回调
                 */
                static reloadPageWithMessageCallback = (msg, cb) => {
                    if (cb) {
                        cb();
                    }
                    setTimeout(function () {
