    ...
    return {
        ...
        execute: function () {
            ...
            SiyuanDevice = class SiyuanDevice {
                 ...
                 * @param type - 类型
                 */
                static getImportJsPath(jsPath, type) {
                 ...
                 */
                static getZhiThemeImportJsPath(jsPath) {
                    return this.getImportJsPath(jsPath, basePathTypeEnum_js_1.default.BasePathType_ZhiTheme);
                }
                // =========================
                // import start
                // =========================
