...
- [siyuan-plugin-local-service](https://github.com/terwer/siyuan-plugin-local-service) - Local service <sup>Now Available</sup> <a title="Releases" target="_blank" href="https://github.com/terwer/siyuan-plugin-local-service/releases"><img src="https://img.shields.io/github/release/terwer/siyuan-plugin-local-service.svg?style=flat-square&color=9CF"></a>