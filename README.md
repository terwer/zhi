...
- [X] [siyuan-plugin-2md](https://github.com/terwer/siyuan-plugin-2md) - Markdown batch convert <sup>Now Available</sup> <a title="Releases" target="_blank" href="https://github.com/terwer/siyuan-plugin-local-service/releases"><img src="https://img.shields.io/github/release/terwer/siyuan-plugin-2md.svg?style=flat-square&color=9CF"></a>
- [X] [siyuan-plugin-share-pro](https://github.com/terwerinc/siyuan-plugin-share-pro) - Share your doc via one click <sup>Now Available</sup> <a title="Releases" target="_blank" href="https://github.com/terwerinc/siyuan-plugin-share-pro/releases"><img src="https://img.shields.io/github/release/terwerinc/siyuan-plugin-share-pro.svg?style=flat-square&color=9CF"></a>