...
import ZhiBlogNuxtUtil from "~/utils/ZhiBlogNuxtUtil"
import { Post } from "zhi-blog-api"

// env
const nuxtEnv = useRuntimeConfig()
const env = new Env(nuxtEnv.public)
ZhiBlogNuxtUtil.initEnv(env)
// const logger = ZhiWebBlogUtil.zhiLog("detail-page")
await ZhiBlogNuxtUtil.importLute(env.getStringEnv("VITE_APP_BASE"), env.getStringEnv("VITE_STATIC_VERSION"))
